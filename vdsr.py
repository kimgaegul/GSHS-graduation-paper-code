...
Original file is located at
    https://colab.research.google.com/drive/1yv6fpF0twIR8YO6spGlxd6yhAMcbHGWX
"""
...
'''def create_model(tree_depth):
    models =  Conv2D(64, (3, 3), padding='zero', kernel_initializer='he_normal', activation = 'relu')(input_img)
    for i in range(tree_depth):
        model = Conv2D(64, (3, 3), padding='zero', kernel_initializer='he_normal', activation = 'relu')(model)
        models.append(model)
...
model = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal', activation = 'relu')(model)
model = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal', activation = 'relu')(model)
model = Conv2D(3, (3, 3), padding='same', kernel_initializer='he_normal', activation = 'relu')(model)
res_img = model
...
model_img_file = '/content/drive/MyDrive/VDSR_model.png'
...
model.save("/content/drive/MyDrive/vdsr_50.h5")
...
plt.ylabel('PSNR')
plt.xlabel('epoch')
plt.title('VDSR - PSNR Graph')
plt.savefig('/content/drive/MyDrive/VDSR-PSNR_Graph.png')
plt.show()

plt.plot(model_history.history['ssim'])

plt.legend(['training loss', 'validation loss'], loc = 'upper right')
plt.title('VDSR- SSIM Graph')
plt.xlabel('epoch')
plt.ylabel('SSIM')
plt.savefig('/content/drive/MyDrive/VDSR-SSIM_Graph.png')
plt.show()